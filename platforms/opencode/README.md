...
| `implement-flow` | `platforms/opencode/flow-skills/implement-flow/SKILL.md` | Phase: implement one task flow |
...
for skill in ai-flow-anything design-flow implement-flow pr-flow test-flow deploy-flow docs-flow; do
