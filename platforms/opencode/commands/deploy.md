...
Run the **deploy-wizard** for: $ARGUMENTS

The argument is the feature or release scope (or empty for "current main").

Load the `deploy-wizard` skill (or read `.ai-workflow/wizards/deploy-wizard.md` directly) and execute its phases:
